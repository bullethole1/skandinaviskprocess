                ...
                <div class="businessup-header-box wow animated flipInX">
                  <div class="businessup-header-box-icon header-info-one">
                    ...
                    if( !empty($businessup_header_widget_one_icon) ):
                        echo '<i class="fa '.esc_attr($businessup_header_widget_one_icon).'"><img src="http://localhost/skandinaviskprocess/wp-content/uploads/2020/11/phone-call.png" /></i>';
                    endif; ?>
                   </div>
                ...
                <div class="businessup-header-box">
                  <div class="businessup-header-box-icon header-info-two">
                    ...
                    if( !empty($businessup_header_widget_two_icon) ):
                      echo '<i class="fa '.esc_attr($businessup_header_widget_two_icon).'"><img src="http://localhost/skandinaviskprocess/wp-content/uploads/2020/11/pin.png" /></i>';
                    endif; ?>
                   </div>
                  <div class="businessup-header-box-info">
                ...
                <div class="businessup-header-box">
                  <div class="businessup-header-box-icon header-info-three">
                    ...
                    if( !empty($businessup_header_widget_three_icon) ):
                        echo '<i class="fa '.esc_attr($businessup_header_widget_two_icon).'"><img src="http://localhost/skandinaviskprocess/wp-content/uploads/2020/11/clock.png" /></i>';
                    endif; ?>
                   </div>
                  <div class="businessup-header-box-info">
